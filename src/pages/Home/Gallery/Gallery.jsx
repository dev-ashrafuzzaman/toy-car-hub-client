    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="grid-cols-3 md:p-10 p-2 space-y-2 mt-2 lg:space-y-0 lg:grid lg:gap-3 lg:grid-rows-3">
                <div data-aos="fade-right" className="w-full overflow-hidden rounded-lg">
                ...
                <div data-aos="fade-left" className="w-full col-span-2 row-span-2 overflow-hidden rounded-lg">
                ...
                <div data-aos="fade-up-right" className="w-full overflow-hidden rounded-lg">
                    <img className="rounded-lg hover:scale-125 transition-all duration-500 cursor-pointer" src="https://images.unsplash.com/photo-1591438252948-fa5dd3701c2a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                        alt="image" />
                </div>
                <div data-aos="fade-down-right" className="w-full overflow-hidden rounded-lg">
                    <img className="rounded-lg hover:scale-125 transition-all duration-500 cursor-pointer" src="https://images.unsplash.com/photo-1591438252948-fa5dd3701c2a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                        alt="image" />
                </div>
                <div data-aos="fade-down-left" className="w-full overflow-hidden rounded-lg">
                    <img className="rounded-lg hover:scale-125 transition-all duration-500 cursor-pointer" src="https://images.unsplash.com/photo-1591438252948-fa5dd3701c2a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                        alt="image" />
                </div>
                <div data-aos="fade-down-left" className="w-full overflow-hidden rounded-lg">
